...
import CustomColorPicker from "@/components/custom-ui/personalize/page-component/Colorpicker";
...
const Page = () => {
  ...
  return (
    <div className=" h-full w-full flex-col md:flex">
      <div className="p-3 bg-gray-400 flex flex-col items-start justify-between space-y-2 py-4 sm:flex-row sm:items-center sm:space-y-0 ">
      ...
      <div className=" h-full w-full px-16 py-6  grid grid-cols-5 justify-center gap-4">
        <div className="min-h-[400px] col-span-4 flex-1 p-4 md:min-h-[700px] lg:min-h-[700px] bg-white rounded ">
          {/* <MobileScreen/> */}
          {screenType === "mobile" ? <MobileScreen /> : <DesktopScreen />}
        </div>
